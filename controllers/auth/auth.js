...
const checkUsernameAvailability = async (req, res) => {
  ...
  console.log("checkUsernameAvailability-backend",username);
...
const signInWithGoogle = async (req, res) => {
  const { last_name, id_token, first_name, profile_picture, username } = req.body;

  console.log("signInWithGoogle-api-backend",req.body);
  ...
  //   user: {
  //     full_name: `${'dfssfds'} ${'sdfdsfd'}`,
  //     id: 'fsdfsd',
  //     username: 'dsfdsf',
  //     profile_picture: 'dsfdsf',
  //     email: 'dsfsdfds',
  //   },
  //   tokens: { access_token: 'sdasadsad', refresh_token: 'sadsadas' },
  // });
